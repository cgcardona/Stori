# 🎵 TellUrStori V2 DAW - App Icon Setup Guide

This guide will help you set up the beautiful app icon for TellUrStori V2 DAW.
...
1. **Open Xcode**: Open `TellUrStoriDAW.xcodeproj`
2. **Navigate to Assets**: Go to `TellUrStoriDAW` → `Assets.xcassets` → `AppIcon`
...
```
TellUrStoriDAW/Assets.xcassets/AppIcon.appiconset/
├── Contents.json
├── icon_16x16.png
├── icon_16x16@2x.png
├── icon_32x32.png
...
Once setup is complete, your TellUrStori V2 DAW will have a beautiful, professional app icon that represents the innovative combination of:
